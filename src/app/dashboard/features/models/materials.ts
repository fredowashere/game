...
export const DEFAULT_MATERIALS: IMaterials = {
    11: { id: 11, name: "Unlock", color: 'rgba(0,255,255,1)', solid: false, script: 'game.current_map.keys[10].solid = 0;\ngame.current_map.keys[10].color = "#888";' },
    ...
    7: { id: 7, name: "Change Color", color: 'rgba(115,198,250,1)', solid: false, script: 'game.player.color = "#"+(Math.random()*0xFFFFFF<<0).toString(16);' },
